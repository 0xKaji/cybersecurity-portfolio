...
The scan shows that the plugin jsmol2wp is installed. This plugin is known for having a Local File Inclusion vulnerability [PoC](https://github.com/sullo/advisory-archives/blob/master/wordpress-jsmol2wp-CVE-2018-20463-CVE-2018-20462.txt)
...
Sortly after, I found out i didn't have any meaningful permissions, so i couldn't execute some powerful [scripts](https://github.com/nowak0x01/WPXStrike)
